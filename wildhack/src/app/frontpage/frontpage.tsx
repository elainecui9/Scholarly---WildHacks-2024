            ...
            <div>
              ...
              onChange={handleQueryChange}
                ...
                <div className="flex text-white">
                  <Link href={`/journals?search=${query}`} className="ml-2 font-semibold rounded-full bg-black py-2 px-8 text-white transition-transform duration-300 transform hover:scale-105 rounded-xl shadow-md shadow-gray-400">
                    <div className="flex">
